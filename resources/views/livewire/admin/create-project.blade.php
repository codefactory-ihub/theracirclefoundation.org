        ...
        <x-form-section submit="saveForm">
            <x-slot name="form">
                ...
                <div class="col-span-6">
                    <x-label for="archived" value="{{ __('Visibility') }}" />
                    <x-select
                        id="archived"
                        wire:model="archived"
                ...
                <div class="col-span-6">
                    ...
                    <x-input id="short_description" type="text" class="mt-1 block w-full"
                             wire:model="short_description" required autocomplete="short_description" />
                        ...
                        <div class="w-full sm:w-6/12 flex gap-3 items-end">
                            ...
                            <div class="w-full sm:w-2/12">
                                <x-button
                                    type="button"
                                    wire:click="addFile"
                                    class="py-3.5 w-full justify-center relative"
                                    wire:loading.attr="disabled"
                                >
                                    <div wire:loading.remove wire:target="addFile">
                                        {{ __('Add') }}
                                    </div>
                                    <div wire:loading wire:target="addFile" class="absolute inset-0 flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-4 md:grid-cols-10 gap-2 py-3">
                            @foreach ($files as $file)
                                <div class="relative aspect-square">
                                    ...
                                    >
                                        <div wire:loading.remove wire:target="deleteFile('{{$file['id']}}')">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-x">
                                                <path d="M18 6 6 18"/>
                                                <path d="m6 6 12 12"/>
                                            </svg>
                                        </div>
                                        <div wire:loading wire:target="deleteFile('{{$file['id']}}')">
            ...
            <x-slot name="actions">
                ...
                <x-button wire:loading.attr="disabled" class="py-3.5 justify-center relative">
